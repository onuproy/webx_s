! function(e) {
  "use strict";
  e("#tabs").tabs(), e(".navbar-toggler").click(function() {
    e(".mobile-sider-drawer-menu").toggleClass("active")
  }), e(".counter").counterUp({
    delay: 10,
    time: 2e3
  ...
  }), jQuery(".sub-menu").parent("li").addClass("has-child"), jQuery("<div class='fa fa-angle-right submenu-toogle'></div>").insertAfter(".has-child > a"), jQuery(".has-child a+.submenu-toogle").on("click", function(e) {
    ...
    jQuery(".slick-testimonials-content").slick({
    ...
    }), jQuery('iframe[src*="youtube.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), jQuery('iframe[src*="vimeo.com"]').wrap('<div class="embed-responsive embed-responsive-16by9"></div>'), lc_lightbox(".elem", {
    ...
    }), e(".rightSidebar").theiaStickySidebar({
      additionalMarginTop: 100
    }), scroll_top(), jQuery(document).on("change", ".btn-file :file", function() {
      var e = jQuery(this),
        i = e.get(0).files ? e.get(0).files.length : 1,
        s = e.val().replace(/\\/g, "/").replace(/.*\//, "");
      e.trigger("fileselect", [i, s])
    }), jQuery(".btn-file :file").on("fileselect", function(e, i, s) {
      var t = jQuery(this).parents(".input-group").find(":text"),
        a = i > 10 ? i + " files selected" : s;
      t.length ? t.val(a) : a && alert(a)
    ...
    })), mobile_nav(), jQuery("#mobile-side-drawer").on("click", function() {
      ...
      delay: 10,
      time: 3e3
    }), jQuery("div.booking-tab-menu>div.list-group>a").click(function(i) {
      i.preventDefault(), jQuery(this).siblings("a.active").removeClass("active"), jQuery(this).addClass("active");
      var s = e(this).index();
      jQuery("div.booking-tab>div.booking-tab-content").removeClass("active"), jQuery("div.booking-tab>div.booking-tab-content").eq(s).addClass("active")
    ...
    (function() {
      if (jQuery().isotope) {
        ...
        e.isotope({
          ...
          var i = jQuery(this).find("a").attr("data-filter");
    ...
    return jQuery.ajax({
      ...
      data: i.serialize() + "&action=contactform",
      type: "POST",
      dataType: "JSON",
      beforeSend: function() {
